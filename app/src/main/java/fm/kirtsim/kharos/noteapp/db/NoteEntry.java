...
class NoteEntry {
    ...
    static final String ATT_ORDER_NO = "order_no";
    static final String ATT_COLOR = "color";
    static final String ATT_PINNED = "is_pinned";
    static final String ATT_TEXT = "text";
    static final String ATT_TITLE = "title";
    static final String ATT_MODIFY_DATE = "modified_at";
}
